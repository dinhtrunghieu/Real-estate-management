...
public interface UserRepository extends JpaRepository<UserEntity, Long>, UserRepositoryCustom {
    List<UserEntity> findByIdIn (Long[] id);
   ...
   // UserEntity findById(Long id);
    ...
    List<UserEntity> findByStatusAndRoles_code(Integer status, String staff);
    List<UserEntity> findByBuildingIn(BuildingEntity buildingEntity);
}
